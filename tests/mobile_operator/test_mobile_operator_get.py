...
from schema import mobile_operator
...
class TestMobileOperatorGet:
    ...
    def test_schema(self, endpoint):
        r = endpoint.get()
        validate(r.json(), mobile_operator.foreign_key_schema())
    ...
    def test_response_contains_only_given_columns(self, endpoint, columns):
        ...
        validate(r.json(), mobile_operator.foreign_key_schema(columns))
    ...
    def test_filter_by_attribute(self, endpoint, data_mobile_operator):
        name = data_mobile_operator["body"]["values"][0]["name"]
        body = {
    ...
    def test_filter_by_multiple_attributes(self, endpoint, data_mobile_operator):
        name = data_mobile_operator["body"]["values"][0]["name"]
        id_ = data_mobile_operator["ids"][0]
        body = {
            "filter_by": [
    ...
    def test_search_by(self, endpoint, data_mobile_operator):
        name = data_mobile_operator["body"]["values"][0]["name"]
        id_ = data_mobile_operator["ids"][0]
        body = {
            "search_by": [
